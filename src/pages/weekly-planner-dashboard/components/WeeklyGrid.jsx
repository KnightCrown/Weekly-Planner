          ...
          {days?.map(day => {
            ...
            return (
              <div key={day} className="text-center">
                <h3 className="font-semibold text-gray-900 text-sm mb-1">{day}</h3>
              ...
              <div className="mb-1 w-full">
                {editingTimeSlot === timeSlot && editingField === 'name' ? (
                  <input
                    ...
                    className="w-full max-w-[120px] font-medium text-gray-700 text-sm bg-transparent border border-gray-300 rounded px-1 py-0.5"
                    autoFocus
                    maxLength={20}
                  />
                ) : (
                  <span 
                    className="font-medium text-gray-700 text-sm cursor-pointer hover:text-blue-600 transition-colors flex items-center group max-w-[120px] truncate"
              ...
              <div className="w-full">
                {editingTimeSlot === timeSlot && editingField === 'subtitle' ? (
                  <input
                    ...
                    onBlur={handleTimeSlotSave}
                    onKeyDown={handleKeyPress}
                    className="w-full max-w-[120px] text-xs text-gray-500 bg-transparent border border-gray-300 rounded px-1 py-0.5"
                    autoFocus
                    maxLength={30}
                  />
                ) : (
                  <span 
                    className="text-xs text-gray-500 cursor-pointer hover:text-blue-500 transition-colors group flex items-center max-w-[120px] truncate"
